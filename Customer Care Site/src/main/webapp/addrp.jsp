                ...
                <form action="addrp.jsp" class="row g-3" novalidate="">
                    ...
                    <div class="col-md-4"><label class="form-label">Voice Service</label>
                        <select name="voice" class="form-select" aria-label="Default select example">
                            ...
                            %>
                            <option value="<%=servicePackage.getId()%>"><%=servicePackage.getUnits()%>
                            </option>
                            <%
                                    }
                                } catch (SQLException e) {
                    ...
                    <div class="col-md-4">
                        ...
                        <label class="form-label" for="validationCustom02">Additional minutes</label> <input
                            name="AddMin" class="form-control" id="validationCustom02">
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                    <%--          ---------------------------------------------               --%>
                    <div class="col-md-4">

                        <label class="form-label" for="validationCustom03">Additional sms</label> <input
                            name="AddSMS" class="form-control" id="validationCustom03">
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                    <%--          ---------------------------------------------               --%>
                    <div class="col-md-4">

                        <label class="form-label" for="validationCustom04">Additional data</label> <input
                            name="AddData" class="form-control" id="validationCustom04">
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                    <%--          ---------------------------------------------               --%>
                    <div class="col-md-4">

                        <label class="form-label" for="validationCustom05">Additional roaming</label> <input
                            name="AddRoam" class="form-control" id="validationCustom05">
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                    <%--          ---------------------------------------------               --%>
                    <div class="col-md-4">

                        <label class="form-label" for="validationCustom06">fee</label> <input
                            name="fee" class="form-control" id="validationCustom06">
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                    <%--          ---------------------------------------------               --%>
